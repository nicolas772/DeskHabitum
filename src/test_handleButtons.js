...
async function stop_cam(){
    ...
    let [total_unhas, total_pelo, total_objeto]  = window.api.obtenerTotal()
    ...
    await window.api.createSesion(ID_USER, ini_sesion, fini_sesion, total, total_unhas, total_pelo, total_objeto); 
